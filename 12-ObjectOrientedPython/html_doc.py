...
class Body(Tag):
    ...
    def __init__(self):
        super().__init__('body', '')  # body content will be build separately
        self._body_contents = []
...
class HtmlDoc(object):
    ...
    def add_head(self, name, content):
        self._head.add_tag(name, content)
...
if __name__ == '__main__':
    my_page = HtmlDoc()
    my_page.add_head('title', 'Document title')
