...
class Album:
    ...
    Attributes:
        ...
        year (ini): The year album was released.
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_album is None:
                ...
                # retreive the album object if there is one,
                # otherwise create a new album object and store it to the artist's collection.
