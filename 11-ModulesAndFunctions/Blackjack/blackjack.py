...
def deal_card(frame):
    ...
    next_card = deck.pop(0) # with 0 takes card from top of the deck, empty from bottom
...
card_frame = tkinter.Frame(mainWindow, relief="sunken", borderwidth=1, background="blue")
